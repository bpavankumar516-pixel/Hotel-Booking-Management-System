...
export const PlatformAndTasks = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Row 2: Reservations Bar Chart + Reservation Status Share Donut + Tasks Widget */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-stretch">
        ...
        {/* 2. Reservation Status Share Donut Chart (4 cols) */}
        <div className="lg:col-span-4 bg-white border border-slate-200/80 p-5 rounded-3xl shadow-xs flex flex-col justify-between space-y-4">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs pt-2 border-t border-slate-100">
            {reservationStatusData.map((p, idx) => (
              <div key={idx} className="flex items-center justify-between p-1.5 rounded-xl border border-slate-100 bg-slate-50/80">
